function loadHeader(){
    document.getElementById('header').innerHTML = `      
        <div class="header-menu">
            <label for="menu-burger-btn" class="ham_menu">
                <span></span>
                <span></span>
                <span></span>
                <button id="menu-burger-btn">Menu Nav</button>
            </label>
            <h1><a href="/">Imaginatio</a></h1>
        </div>
        <label class="header-account" for="menu-account-btn">
            ...
            <button id="menu-account-btn">Menu Account</button>
        </label>
    `;
}
    ...
    document.getElementById('footer').innerHTML = `
        ...
        <div class="footer-ext-info">
            <ul>
                ...
                <li>kilómetro 2, vía Cajicá-Zipaquirá.</li>
        ...
        <div class="footer-content">
            <div class="footer_social">
                <svg class="icon icon_instagram" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="icon icon_www" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 54.438 54.438" xml:space="preserve">
                ...
                <svg class="icon icon_twt" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="icon icon_yt" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <style>
                            .cls-1{fill:none;}
                        </style>
                ...
                <svg class="icon icon_fb" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                2025 Gatillo Crew - Ingenier&iacute;a Multimedia &copy;
            </div>
        </div>
        `;
}
